  ...
  return (
    <>
      <div className="relative  mt-20 ">
        <div className={`border-purple-700 border-2 absolute top-16 left-2 md:left-28 right-10 md:right-24 bottom-10 md:bottom-20 rounded-xl`}></div>
        ...
        <figure className="wp-block-media-text__media relative mb-4 pl-0 md:mb-0 md:w-1/2 md:order-first">
          ...
          <div className=" text-wrap w-full md:w-1/2 py-14 md:py-28 pl-20 md:pl-20 pr-20 md:pr-40 z-20 ">
            <h1 className="text-4xl font-semibold mb-8">{title4}</h1>
