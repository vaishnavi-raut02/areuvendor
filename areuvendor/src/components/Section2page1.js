...
const Section2page1 = ({ imagesrc1, title1, description1 }) => {
  return (
    <>
      <div className="flex justify-center m-4 md:m-11 ">
        <div className="container bg-orange-50 rounded-2xl flex flex-col md:flex-row mb-24 ">
          <div className=" w-full md:w-2/4 pl-12 md:pl-0 md:m-10 my-14">
            <h1
          ...
          <figure className="wp-block-media-text__media relative top-16 left-10 md:w-auto  ">
            <Image
              src={imagesrc1}
